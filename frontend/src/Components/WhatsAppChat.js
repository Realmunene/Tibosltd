    ...
    <>
      ...
      {open && (
        <div className="fixed bottom-5 right-5 z-[9999] w-80 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden animate-fadeIn">
          ...
          <div className="p-3">
            <a
              href="https://wa.me/+254719869075"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#FF9306] hover:bg-green-700 text-white font-medium w-full rounded-lg py-2 flex items-center justify-center space-x-2 transition"
            >
          ...
          {/* Footer Credit */}
          <div className="text-[10px] text-center text-black-300 pb-2">
            Powered by <span className="text-[#FF9306] font-semibold">Tibosltd</span>
          </div>
        </div>
      )}
